-- Bloco 21 - dia 02 - Descomplicando JOINS, UNIONS e Subqueries]

USE sakila;

/* 1. Monte uma query que exiba o id do ator , nome do ator e id do filme em que ele já atuou usando as tabelas actor e 
film_actor */

SELECT f.actor_id, a.first_name, a.last_name, f.film_id
...
forma decrescente. Exiba somente os clientes ativos. As informações podem ser encontradas na tabela address e customer.*/
...
SELECT s.first_name, s.last_name, p.amount AS media_valor, p.payment_date
FROM staff AS s
