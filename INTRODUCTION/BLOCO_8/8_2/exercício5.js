...
function fantasyOrScienceFictionAuthors() {
  ...
  const authorFiccaoFantasia = books.filter((book) => book.genre === 'Ficção Científica' || book.genre === 'Fantasia');
  return (authorFiccaoFantasia.map((element) => element.author.name)).sort();
}
