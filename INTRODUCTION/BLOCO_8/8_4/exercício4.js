...
// Escreva uma função filterPeople que, dada uma lista de pessoas, retorna todas as pessoas australianas
// que nasceram no século 20:

// escreva filterPeople abaixo

const filterPeople = (peopleOfWorld) => {
   return peopleOfWorld.filter(({nationality, bornIn}) => {
