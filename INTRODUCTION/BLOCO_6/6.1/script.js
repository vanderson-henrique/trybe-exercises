...
function validacoes(event) {
    ...
    // verificação data
    let dataDigitada = document.querySelector('#data-inicio').value;
    let arrayData = dataDigitada.split('/');
    let formatoData = /^[0-9]{2}\/[0-9]{2}\/[0-9]{4}$/;
    if (!formatoData.test(dataDigitada)){
